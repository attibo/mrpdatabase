...
}else
{
	...
	?>
		...
		<body background="page_center_bg.jpg" bgcolor="gray" font size=3 vLink=#ff6633> 

		<center>
		<style>
		table {
		background-image: url(immagini/sf_trasp_tab);
		}
		</table>
		</style>
	...
	?>
		...
		<style type="text/css">
		<!-- in questo punto eliminato sorgente css -->
		</style>
		...
		*/
		...
		<tr>
			...
			<td bordercolor='black' id='choice4' onmouseover='movein(this,'Disconnessione dal database')' onmouseout='moveout(this)'><a href='disconnect_atticom.php'>Logout (uscita)</a>
			</td>
		</tr>
		<tr>
